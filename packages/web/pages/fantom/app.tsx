    ...
    const init = async () => {
      const reconnect = async () => {
        ...
        if (walletConnected) {
          ...
          if (network !== FantomNetworks.Mainnet && network !== FantomNetworks.Testnet) {
            showMessage(
              'Not connected to Fantom',
              'Your wallet is connected to a different chain. Please switch your network in order to sign in to Block Fabric for Fantom.',
            );
            return;
          }
