...
export function CardReview2() {
  return (
    <Card elevation={0} sx={{ display: 'flex', padding: 2, borderRadius: '16px' }}>
      <CardContent sx={{ pr: 2 }}>
        <Box mb={1}>
          <Box
            component="h3"
          ...
          <Rating name={'rating'} value={2} size={'small'} sx={{ verticalAlign: 'text-top' }} />
        </Box>
        <Box component="p" sx={{ fontSize: 14, color: 'grey.500', mb: '1.275rem' }}>
          Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing
          layouts and visual mockups. credit (www.brighttv.co.th)
        </Box>
