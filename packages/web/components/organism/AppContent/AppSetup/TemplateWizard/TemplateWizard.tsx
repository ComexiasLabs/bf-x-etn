...
export default function TemplateWizard({ app, onSetupFinish, onCancel }: TemplateWizardProps) {
  ...
  return (
    <>
      ...
      {currentStep === 0 && (
        <>
          <Step1ChooseTemplate onSelect={(template) => setSelectedTemplate(template)} />
