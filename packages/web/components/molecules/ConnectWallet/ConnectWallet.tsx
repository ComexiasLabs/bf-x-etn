...
const ConnectWallet = ({ blockchain, onConnectClick, isLoading }: ConnectWalletProps) => {
        ...
        <Col md={5} sm={12}>
          <div className={styles.introContainer}>
            ...
            <div style={{ paddingTop: 30 }}>
              <Button className={styles.buttonHighlight} onClick={() => onConnectClick()} disabled={isLoading}>
